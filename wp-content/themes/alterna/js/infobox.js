  ...
  "use strict";
	...
	function googleMapInit(){
		...
		function showMap(params){
			...
			var theme	= $(params).attr("data-theme");
			...
			if(show_marker){
				...
				if(show_info){
					...
					var themename = '';
					switch(parseInt(theme)){
						case 1:  themename = 'white';break;
						case 2:  themename = 'black';break;
						default: 
							if(theme != "0"){	themename = theme;}
					}
					$(boxText).addClass('map-info-window');
					if(themename !== ''){
						$(boxText).addClass(themename);
					}
					boxText.innerHTML = $('#'+map_id+'-map-info').html();
					$('#'+map_id+'-map-info').remove();
					...
					var myOptions = {
						...
						zIndex: null,
						boxStyle: {
						background: "url('" + info_bg_img + "') no-repeat center 0px",width: info_box_width+"px"},
						closeBoxMargin: "-6px 0 0 0",
