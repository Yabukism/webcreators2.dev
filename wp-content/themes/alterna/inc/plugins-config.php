 ...
 */
require_once dirname( __FILE__ ) . '/tools/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'themefocus_register_required_plugins' );
 ...
 */
function themefocus_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		// This is an example of how to include a plugin pre-packaged with a theme
                ...
                array(
                        ...
                        'source'   				=> get_template_directory_uri() . '/recommended_plugins/layersliderwp-5.5.0.installable.zip', // The plugin source
                        'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
                        'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
                        'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
                        'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
                ...
                array(
                        ...
                        'source'   				=> get_template_directory_uri() . '/recommended_plugins/revslider4.6.93.zip', // The plugin source
                        'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
                        'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
                        'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
                        'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
	...
	$config = array(
		...
		'parent_slug'  => 'alterna_options_page',            // Parent menu slug.
