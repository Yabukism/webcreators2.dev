...
class ESSBSocialShareAnalyticsBackEnd {
	...
	public static function essb_stats_by_networks($month = '', $post_id = '') {
	...
	public static function essb_stats_by_position($month = '', $post_id = '') {
		global $wpdb, $essb_options, $essb_networks;
	...
	public static function essb_stat_admin_detail_by_post($month = '', $networks_with_data, $limit = '') {
		global $wpdb, $essb_networks;
		$table_name = $wpdb->prefix . ESSB3_TRACKER_TABLE;
