...
class EasySocialShareButtons_Widget3 extends WP_Widget {
	...
	function EasySocialShareButtons_Widget3() {
		//$this->WP_Widget( 'easy-social-share-buttons-widget', 'Easy Social Share Buttons: Share Widget');
	...
	function widget( $args, $instance ) {
		...
		$shortcode = '[easy-social-share buttons="'.$buttons.'" native="no"';
	...
	function form( $instance ) {
		global $essb_networks, $essb_avaiable_total_counter_position, $essb_avaliable_counter_positions, $essb_available_tempaltes;
