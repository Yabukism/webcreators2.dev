...
class ESSBShortcodeGenerator3 {
	...
	function __construct() {
		global $essb_avaliable_counter_positions, $essb_avaiable_total_counter_position, $essb_avaiable_button_style;
...
jQuery(document).ready(function(){
	...
	public function generate($options) {
		...
		foreach ($this->shortcodeOptions as $param => $settings) {
			...
			if ($type == "networks" || $type == "networks_sp") {
	...
	private function includeOptionsForEasyFans() {
		$this->shortcode = 'easy-fans';
		$this->shortcodeTitle = '[easy-fans] Shortcode';

		$this->register("title", array("type" => "textbox", "text" => "Title of widget", "comment" => "", "value" => "", "fullwidth" => "true"));
		$this->register("hide_title", array("type" => "checkbox", "text" => "Hide title:", "comment" => "Activate this option to remove the title element of fans counter widget", "value" => "1"));
		$this->register("show_total", array("type" => "checkbox", "text" => "Show number of total fans:", "comment" => "Display total fans as text or box (based on general design settings)", "value" => "1"));
		
		$this->register('subsection2', array("type" => "subsection", "text" => "Visual settings"));
		
		$listOfCols = array("1" => "1 Column", "2" => "2 Columns", "3" => "3 Columns", "4" => "4 Columns");
		$listOfTemplates = array("color" => "Color icons", "grey" => "Grey icons", "metro" => "Metro", "flat" => "Flat", "dark" => "Dark", "lite" => "Lite icons on transparent background", "grey-transparent" => "Grey icons on transparent background", "color-transparent" => "Color icons on transparent background");
