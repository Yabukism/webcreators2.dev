...
global $essb_navigation_tabs, $essb_sidebar_sections, $essb_section_options, $essb_available_social_networks;
...
if ($settings_update == "true") {
	//printf('<div class="updated" style="padding: 10px;">%1$s</div>', __('Easy Social Share Buttons options are saved!', ESSB3_TEXT_DOMAIN));
	printf('<div class="essb-information-box"><div class="icon"><i class="fa fa-info-circle"></i></div><div class="inner">%1$s</div></div>', __('Easy Social Share Buttons options are saved!', ESSB3_TEXT_DOMAIN));
}
$settings_imported = isset($_REQUEST['settings-imported']) ? $_REQUEST['settings-imported'] : '';
if ($settings_imported == "true") {
	//printf('<div class="updated" style="padding: 10px;">%1$s</div>', __('Easy Social Share Buttons options are saved!', ESSB3_TEXT_DOMAIN));
	printf('<div class="essb-information-box"><div class="icon"><i class="fa fa-info-circle"></i></div><div class="inner">%1$s</div></div>', __('Easy Social Share Buttons options are imported!', ESSB3_TEXT_DOMAIN));
}
if ($reset_settings == 'true') {
	printf('<div class="essb-information-box"><div class="icon"><i class="fa fa-gear"></i></div><div class="inner">%1$s</div></div>', __('Plugin settings are restored to default.', ESSB3_TEXT_DOMAIN));
}
