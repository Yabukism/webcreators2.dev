...
function essb_register_settings_metabox_visual() {
	global $post, $essb_avaiable_button_style, $essb_available_tempaltes,
	$essb_avaliable_counter_positions, $essb_avaiable_total_counter_position, $essb_avaliable_content_positions, $essb_available_button_positions;
	...
	if (isset ( $_GET ['action'] )) {
		...
		$animations_container = array ("" => "Default value from settings", "no" => "No", "smooth" => "Smooth colors", "pop" => "Pop up", "zoom" => "Zoom out", "flip" => "Flip");
