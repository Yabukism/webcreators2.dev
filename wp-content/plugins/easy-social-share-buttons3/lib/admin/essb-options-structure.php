...
ESSBOptionsStructureHelper::field_select('quick', 'quick-2', 'fixed_width_align', __('Choose alignment of network name', ESSB3_TEXT_DOMAIN), __('Provide different alignment of network name (counter when position inside or inside name) when fixed button width is activated. Default value is center.', ESSB3_TEXT_DOMAIN), array("" => "Center", "left" => "Left", "right" => "Right"));
...
ESSBOptionsStructureHelper::field_select('quick', 'quick-7', 'mobile_sharebuttonsbar_count', __('Number of buttons in share buttons bar', ESSB3_TEXT_DOMAIN), __('Provide number of buttons you wish to see in buttons bar. If the number of activated buttons is greater than selected here the last button will be more button which will open popup with all active buttons.', ESSB3_TEXT_DOMAIN), $listOfOptions);
...
//---- import export
ESSBOptionsStructureHelper::menu_item('import', 'backup', __('Import / Export Options', ESSB3_TEXT_DOMAIN), 'database');
ESSBOptionsStructureHelper::menu_item('import', 'readymade', __('Apply Ready Made Style', ESSB3_TEXT_DOMAIN), 'square');
ESSBOptionsStructureHelper::field_heading('import', 'backup', 'heading1', __('Import / Export Plugin Settings', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_func('import', 'backup', 'essb3_text_backup', __('Configuration string', ESSB3_TEXT_DOMAIN), '');
...
ESSBOptionsStructureHelper::field_select('social', 'sharing-1', 'fixed_width_align', __('Choose alignment of network name', ESSB3_TEXT_DOMAIN), __('Provide different alignment of network name (counter when position inside or inside name) when fixed button width is activated. Default value is center.', ESSB3_TEXT_DOMAIN), array("" => "Center", "left" => "Left", "right" => "Right"));
...
ESSBOptionsStructureHelper::field_checkbox('social', 'sharing-3', 'twitter_always_count_full', __('Make Twitter always count full post/page address when using shorurl', ESSB3_TEXT_DOMAIN), '');
...
$listOfValues = array ("form" => "Send mail using popup form", "link" => "Send mail using mailto link and user mail client" );
ESSBOptionsStructureHelper::field_select('social', 'sharing-3', 'mail_function', __('Send to mail button function', ESSB3_TEXT_DOMAIN), __('Choose how you wish mail button to operate. By default it uses the build in popup window with sendmail option but you can change this to link option to force use of client mail program.', ESSB3_TEXT_DOMAIN), $listOfValues);
...
ESSBOptionsStructureHelper::field_section_start('social', 'sharing-3', __('Antispan Captcha Verification', ESSB3_TEXT_DOMAIN), __('Fill both fields for question and answer to prevent sending message without entering the correct answer.', ESSB3_TEXT_DOMAIN), '');
...
ESSBOptionsStructureHelper::field_switch('social', 'sharing-3', 'print_use_printfriendly', __('Use for printing printfreidly.com', ESSB3_TEXT_DOMAIN), __('Activate that option to use printfriendly.com as priting service instead of default print function of browser', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_switch('social', 'sharing-4', 'force_counters_admin', __('Load counters with build-in WordPress AJAX functions (using admin-ajax)', ESSB3_TEXT_DOMAIN), __('This method is more secure and required by some hosting companies but may slow down page load.', ESSB3_TEXT_DOMAIN), 'yes', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_section_start('social', 'sharing-4', __('Counter Cache', ESSB3_TEXT_DOMAIN), __('This will reduce load because counters will be updated when cache expires', ESSB3_TEXT_DOMAIN), '');
...
ESSBOptionsStructureHelper::field_textbox('social', 'sharing-4', 'counter_total_text', __('Change total text', ESSB3_TEXT_DOMAIN), __('This option allows you to change text Total that appear when left/right postion of total counter is selected.', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_switch('social', 'sharing-6', 'stats_active', __('Activate Statistics', ESSB3_TEXT_DOMAIN), __('Click statistics hanlde click on share buttons and you are able to see detailed view of user activity. Please note that plugin log clicks of buttons.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_switch('social', 'sharing-7', 'sso_apply_the_content', __('Extract full content when generating description', ESSB3_TEXT_DOMAIN), __('If you see shortcodes in your description activate this option to extract as full rendered content.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_switch('social', 'sharing-7', 'sso_google_markup', __('Include Google Schema.org base markup', ESSB3_TEXT_DOMAIN), __('This will include minimal needed markup for Google schema.org (name, descriptio and image)', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_file('social', 'sharing-8', 'customshare_image', __('Custom Share Image', ESSB3_TEXT_DOMAIN), __('This option allows you to pass custom image to your share message (only Facebok and Pinterest support this).', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_textbox('social', 'sharing-9', 'mycred_points', __('myCred reward points for share link click', ESSB3_TEXT_DOMAIN), __('Provide custom points to reward user when share link. If nothing is provided a 1 point will be included.', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_textbox('social', 'sharing-9', 'mycred_group', __('myCred custom point type', ESSB3_TEXT_DOMAIN), __('Provide custom meta key for the points that will user get to share link. To create your own please visit this tutorial: http://codex.mycred.me/get-started/multiple-point-types/. Leave blank to use the default (mycred_default)', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_textbox_stretched('social', 'native-1', 'pinterestfollow_url', __('Profile url when follow type is selected', ESSB3_TEXT_DOMAIN), __('Provide your Pinterets URL as it is seen at the browser, for example https://www.pinterest.com/appscreo.', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_section_end('social', 'native-1');
...
ESSBOptionsStructureHelper::field_switch('social', 'native-1', 'linkedin_follow', __('Include LinkeIn button', ESSB3_TEXT_DOMAIN), __('', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_section_start('social', 'after-share-1', __('Popup message settings', ESSB3_TEXT_DOMAIN), __('', ESSB3_TEXT_DOMAIN), '');
ESSBOptionsStructureHelper::field_textbox('social', 'after-share-1', 'afterclose_popup_width', __('Popup message width', ESSB3_TEXT_DOMAIN), __('Provide custom width in pixels for popup window (number value with px in it. Example: 400). Default popup width is 400.', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-arrows-h', 'right');
ESSBOptionsStructureHelper::field_switch('social', 'after-share-1', 'afterclose_singledisplay', __('Display popup message once for selected time', ESSB3_TEXT_DOMAIN), __('Activate this option to prevent popup window display on every page load. This option will make it display once for selected period of days.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_textbox('social', 'after-share-1', 'afterclose_singledisplay_days', __('Days between popup message display', ESSB3_TEXT_DOMAIN), __('Provide the value of days when popup message will appear again. Leave blank for default value of 7 days.', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-calendar', 'right');
...
ESSBOptionsStructureHelper::field_textbox_stretched('social', 'after-share-2', 'afterclose_like_google_follow_url', __('Include Google Follow Profile button', ESSB3_TEXT_DOMAIN), __('Provide custom width in pixels for popup window (number value with px in it. Example: 400). Default popup width is 400.', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_textbox('social', 'after-share-2', 'afterclose_like_linkedin_company', __('Include LinkedIn Company follow button', ESSB3_TEXT_DOMAIN), __('Provide your LinkedIn comapny ID.', ESSB3_TEXT_DOMAIN));
...
$listOfOptions = array("manage_options" => "Administrator", "delete_pages" => "Editor", "publish_posts" => "Author", "edit_posts" => "Contibutor");
...
ESSBOptionsStructureHelper::field_textbox('display', 'locations-4', 'postfloat_margintop', __('Vertical offset from content start', ESSB3_TEXT_DOMAIN), __('You can provide custom vertical offset from content start. Leave blank to use default value. (Negative values moves up, possitve moves down).', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-arrows-v', 'right');
ESSBOptionsStructureHelper::field_textbox('display', 'locations-4', 'postfloat_percent', __('Display after percent of content is passed', ESSB3_TEXT_DOMAIN), __('Provide percent of conent to viewed when buttons will appear (default state if this field is provided will be hidden for that display method).', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-arrows-h', 'right');
...
ESSBOptionsStructureHelper::field_section_start('display', 'locations-6', __('Top bar appearance', ESSB3_TEXT_DOMAIN), __('If your curent theme has fixed bar or menu you may need to provide custom top position of top bar or it will be rendered below this sticked bar. For example you can try with value 40 (which is equal to 40px from top).', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_textbox('display', 'locations-6', 'topbar_top_onscroll', __('Appear after percent of content is viewed', ESSB3_TEXT_DOMAIN), __('If you wish top bar to appear when user start scrolling fill here percent of conent after is viewed it will be visible.', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-arrows-v', 'right');
...
ESSBOptionsStructureHelper::field_textbox('display', 'locations-8', 'popup_window_popafter', __('Display pop up window after (sec)', ESSB3_TEXT_DOMAIN), __('If you wish popup window to appear after amount of seconds you can provide theme here. Leave blank for immediate popup after page load.', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-arrows-h', 'right');
...
ESSBOptionsStructureHelper::field_switch('display', 'locations-8', 'popup_user_manual_show', __('Manual window display mode', ESSB3_TEXT_DOMAIN), __('Activating manaul display mode will allow you to show window when you decide with calling following javascript function essb_popup_show();', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_section_end('display', 'locations-8');
...
ESSBOptionsStructureHelper::field_textbox_stretched('display', 'locations-8', 'popup_user_autoclose', __('Close up message customize', ESSB3_TEXT_DOMAIN), __('Set custom text announcement for cloasing the pop up. After your text there will be timer counting the seconds leaving.', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_textbox('display', 'locations-9', 'flyin_user_width', __('Fly in window width', ESSB3_TEXT_DOMAIN), __('Set your custom window width (default is 400 or window width - 60). Value if provided should be numeric without px symbols.', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-arrows-h', 'right');
...
ESSBOptionsStructureHelper::field_textbox('display', 'locations-9', 'flyin_window_popafter', __('Display fly in window after (sec)', ESSB3_TEXT_DOMAIN), __('If you wish fly in window to appear after amount of seconds you can provide them here. Leave blank for immediate popup after page load.', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-arrows-h', 'right');
ESSBOptionsStructureHelper::field_textbox('display', 'locations-9', 'flyin_user_percent', __('Display fly in window after percent of content is viewed', ESSB3_TEXT_DOMAIN), __('Set amount of page content after which the popup will appear.', ESSB3_TEXT_DOMAIN), '', 'input60', 'fa-arrows-h', 'right');
...
ESSBOptionsStructureHelper::field_switch('display', 'locations-9', 'flyin_display_comment', __('Display fly in on user comment', ESSB3_TEXT_DOMAIN), __('Automatically display fly in when user leave a comment.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_switch('display', 'locations-9', 'flyin_user_manual_show', __('Manual fly in display mode', ESSB3_TEXT_DOMAIN), __('Activating manaul display mode will allow you to show window when you decide with calling following javascript function essb_flyin_show();', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_section_end('display', 'locations-9');
...
ESSBOptionsStructureHelper::field_textbox_stretched('display', 'locations-9', 'flyin_user_autoclose', __('Close up message customize', ESSB3_TEXT_DOMAIN), __('Set custom text announcement for cloasing the fly in. After your text there will be timer counting the seconds leaving.', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_switch('display', 'locations-9', 'flyin_user_notshow_onclose', __('After user close window do not show it again on this page/post for him', ESSB3_TEXT_DOMAIN), __('Activating this option will set cookie that will not show again popup message for next 7 days for user on this post/page', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_switch('display', 'locations-10', 'sis_pinterest_alt', __('Use provided image alternative text for Pinterest share<div class="essb-new"><span></span></div><div class="essb-beta"><span></span></div>', ESSB3_TEXT_DOMAIN), __('Activate this option to allow Pinterest share take image alternative text as share description. If no such texts is provided it will use post title. If this option is not active Pinterest share will use post title.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_section_end('display', 'locations-10');
...
ESSBOptionsStructureHelper::field_switch('display', 'mobile-1', 'mobile_positions', __('Change display positions on mobile', ESSB3_TEXT_DOMAIN), __('Activate this option to personalize display positions on mobile', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
$listOfOptions = array("2" => "2 Buttons", "3" => "3 Buttons", "4" => "4 Buttons", "5" => "5 Buttons");
ESSBOptionsStructureHelper::field_select('display', 'mobile-1', 'mobile_sharebuttonsbar_count', __('Number of buttons in share buttons bar', ESSB3_TEXT_DOMAIN), __('Provide number of buttons you wish to see in buttons bar. If the number of activated buttons is greater than selected here the last button will be more button which will open popup with all active buttons.', ESSB3_TEXT_DOMAIN), $listOfOptions);
ESSBOptionsStructureHelper::field_switch('display', 'mobile-1', 'mobile_sharebuttonsbar_names', __('Display network names', ESSB3_TEXT_DOMAIN), __('Activate this option to display network names (default is display is icons only).', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_section_end('display', 'mobile-1');
...
ESSBOptionsStructureHelper::field_switch('advanced', 'optimization', 'scripts_in_head', __('Load scripts in head element', ESSB3_TEXT_DOMAIN), __('If you are using caching plugin like W3 Total Cache you may need to activate this option if counters, send mail form or float does not work.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_switch('advanced', 'optimization', 'remove_ver_resource', __('Remove version number from static resource files', ESSB3_TEXT_DOMAIN), __('Activating this option will remove added to resources version number ?ver= which will allow this files to be cached.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_section_end('advanced', 'optimization');

ESSBOptionsStructureHelper::field_section_start('advanced', 'optimization', __('Build in cache', ESSB3_TEXT_DOMAIN), __('Activate build in cache functions to improve speed of load. If you use a site cache plugin activation of those options is not needed as that plugin will do the cache work.', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_switch('advanced', 'optimization', 'essb_cache', __('Activate cache', ESSB3_TEXT_DOMAIN), __('This is option is in beta and if you found any problems using it please report at our <a href="http://support.creoworx.com" target="_blank">support portal</a>. To clear cache you can simply press Update Settings button in Main Settings (cache expiration time is 1 hour)', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_section_start('advanced', 'administrative', __('Advanced Options Activate', ESSB3_TEXT_DOMAIN), __('Activate additional advnaced options for customization and sharing', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_section_start('advanced', 'administrative', __('Plugin Access', ESSB3_TEXT_DOMAIN), __('Control access to various plugin settings', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_section_start('advanced', 'administrative', __('Advanced options', ESSB3_TEXT_DOMAIN), __('Advnaced options that control work of plugin', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'deactivate_fa', __('Do not load FontAwsome', ESSB3_TEXT_DOMAIN), __('Activate this option if you site already uses FontAwsome font.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'deactivate_shorturl_cache', __('Deactivate short url cache', ESSB3_TEXT_DOMAIN), __('Activate this option to stop cache of short url (mainly used if not correct address was initially cached).', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_switch('advanced', 'administrative', 'legacy_class', __('Include class names in CSS from version 2.x', ESSB3_TEXT_DOMAIN), __('Activate this option if you use class names for customization thad does not exist in new version.', ESSB3_TEXT_DOMAIN), '', __('Yes', ESSB3_TEXT_DOMAIN), __('No', ESSB3_TEXT_DOMAIN));
...
function essb3_draw_fanscounter_settings($tab_id, $menu_id) {
	...
	foreach ($network_list as $network => $title) {
		...
		$single_network_options = isset($setting_fields[$network]) ? $setting_fields[$network] : array();
...
function essb_prepare_social_profiles_fields($tab_id, $menu_id) {
	...
	foreach ($essb_available_social_profiles as $key => $text) {
		ESSBOptionsStructureHelper::field_textbox_stretched($tab_id, $menu_id, 'profile_'.$key, $text, __('Enter address to your profile in social network', ESSB3_TEXT_DOMAIN));
	}
}
...
function essb3_text_backup() {
	...
	<a href="<?php echo $goback; ?>" class="button essb-button">Export Settings</a>&nbsp;<input type="Submit" name="Submit" value="Import Settings" class="button essb-button">
	<?php 
}
...
function essb3_post_type_select() {
	...
	$all_lists = in_array ( 'all_lists', $current_posttypes  ) ? 'checked="checked"' : '';
